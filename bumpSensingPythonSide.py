...
if __name__ == '__main__':
    ...
    while True:  
        ...
        if ready ==1:
            ...
            #interestingly ser.write is sending proper data around 95% of the time in this function,
            #and sending data 1 byte at a time using sendString is causing the 
